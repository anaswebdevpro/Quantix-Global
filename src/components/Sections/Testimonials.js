...
const testimonials = [
  {
    ...
    quote:
      "I am extremely satisfied with the services provided by Avner Global, I hired the company for Blockchain In Healthcare Solutions. Their expertise in blockchain technology and healthcare solutions was high in the quality of the blockchain app they developed for me.",
  },
  {
    name: "Angena",
    ...
    quote:
      "As a retail industry professional, I recently hired Avner Global to develop a retail app using blockchain technology. I am extremely satisfied with their services and would highly recommend them to anyone looking for reliable and professional blockchain development solutions.",
  },
  {
    name: "Daniel Richie",
    ...
    quote:
      "Avner Global provided solutions that perfectly met my business requirements. They took the time to understand the specific needs of the agriculture industry and developed a retail app that fit my goals.",
  },
  {
    name: "Eric",
