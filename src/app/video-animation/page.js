...
const features = [

  {
    ...
    icon: "/assets/images/2d-explainer.png",
  },
  {
    ...
    icon: "/assets/images/3d-animation.png",
  },
  {
    ...
    icon: "/assets/images/commercial-videos.png",
  },
  {
    ...
    icon: "/assets/images/corporate-videos.png",
  },
  {
    title: "Web Videos",
    ...
    icon: "/assets/images/web-videos.png",
  },
  {
    title: "Event Videos",
    ...
    icon: "/assets/images/event-videos.png",
  },
          ...
          <div className="flex flex-col md:flex-row items-center gap-10 md:gap-12">
            <div className="flex flex-col w-full md:w-1/2 text-center md:text-left">
              <Heading className="text-white text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                <span className="text-[#09d0c6]"> 3D Video</span> Animation service
              </Heading>
          ...
          <div className="flex flex-col md:flex-row items-center gap-10 md:gap-12">
            <div className="w-full md:w-1/2 order-2 md:order-1">
              <div className="relative h-[300px] md:h-[450px] w-full rounded-2xl overflow-hidden shadow-xl hover:scale-[1.02] transition-transform duration-300">
                <Image
                  src="/assets/images/animation.jpg"
